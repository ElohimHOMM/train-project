          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/2025/day01.html">Day 01</a></li>
                  <li><a class="dropdown-item" href="/2025/day02.html">Day 02</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#">Day 11</a></li>                  
                </ul>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="/unrelated/ausweis.html">Prüfziffer Rechner</a></li>
                </ul>
              </li>
            </ul>
          </div>
